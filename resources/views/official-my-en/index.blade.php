@include('official-my-en.layout.header')
...
<section id="two" class="wrapper post bg-img" data-bg="banner-3.jpg">
    <div class="inner">
        <article class="box">
            ...
            <footer>
                <a href="{{  route('my/en/global-talent-registration') }}" class="button alt">Apply</a>
            </footer>
        </article>
    </div>
        ...
        <article class="box col-md-4">
            ...
            <div class="content">
                <ul>
                    ...
                    <li>Certification Mark: Please hashtag all the following sponsor names, #快拍股份有限公司、#晨悅預防醫學、#菲力斯國際、#H2OHOTEL、#桃園機場捷運、#台灣大車隊、#寶齡富錦生技、#富士康廣告、#創克整合行銷、#Juksy、#Qlive、#好事聯播網、＃宅宅新聞、＃卡卡洛普、＃國王汽車、＃易珈生技、#原綺醫美集團。</li>
    ...
    <div class="inner">
        ...
        <article class="box-1">
            ...
            <ul class="finial-wrapper">
                ...
                <li>Second Place: $NT300,000 equivalent prize and cash.</li>
                <li>Third Place: $NT200,000 equivalent prize and cash.</li><br>
                <li>International Final Competition - The top 3 finalist from each region will compete at SANDS COTAI THEATRE in Macau</li>
                <li>Date: 12/14</li><br>
...
@include('official-my-en.layout.footer')
