...
<head>
    ...
    <title>GLOBAL TOP TALENT CONTEST</title>
</head>
<body>
<div class="navbar navbar-expand-lg fixed-top navbar-dark bg-dark">
    <div class="container">
        <a href="{{ route('homeen') }}" class="navbar-brand">GLOBAL TOP TALENT CONTEST</a>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('homeen') }}">REGISTRATION RULES</a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a href="https://www.facebook.com/全球頂尖紅人對決Official-GTTC-560806931080664/?ref=settings"><img src="https://img.icons8.com/color/36/000000/facebook.png"></a>
                </li>
                <li class="nav-item">
                    <a href="https://www.instagram.com/official.gttc/"><img src="https://img.icons8.com/color/36/000000/instagram-new.png"></a>
                </li>
            </ul>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="bs-component text-center hidden-lg-down">
                <img src="/images/logo-1-en.png" class="img-fluid logo">
                <hr>
            </div>
        </div>
        <div class="col-lg-12">
