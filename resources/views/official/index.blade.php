    ...
    <div class="inner">
        <article class="box">
            <div class="content-wrapper">
                <p>亞洲網路選秀最高賽事!! 全球頂尖紅人對決Global Top Talent Contest，由台灣最強網紅製作團隊快拍,重金打造網路才藝選秀舞台，在上海,北京,哈爾濱,成都,杭州,台北,胡志明,曼谷,吉隆坡,大灣區十個城市分別舉辦，各區前三名,更將前進澳門巴黎人劇場,與其他地區的才藝達人,共同爭取亞太區最強網紅的頭銜!!!</p>
            </div>
            <div class="content-wrapper">
            ...
            <div class="content">
                <p>
                    ...
                    比賽獎金：國際決賽冠軍獎金新台幣獎金 500,000 元（含等值獎品）及獎盃乙座，比賽結果將於最終決賽現場公布並頒發，同時將結果公告於快拍官方平台及臉書粉絲團。
                </p>
            </div>
        </article>
    </div>
    ...
    <div class="inner">
        <article class="box">
            ...
            <ul>
                ...
                <li>3. 如遇天災及不可抗力因素等，主辦單位得延期並公告於官方網站</li>
                <li>4. 一律採線上報名制，參賽者依據指定報名流程，填入個人正確資料。(如因資料有誤影響個人權益需自行負責)</li>
                <li>5. 報名成功後官方系統將自動發信至參賽者信箱，信件內含賽事須知及相關規定，參賽者務必注意官方後續通知。</li>
            </ul>
            <div class="content">
                <p>主辦單位保有調整賽程及補充或修訂內容之權利，參賽人員不得異議，並應遵守參賽規則、服從評審之評定。若以非理性之方式抗議（如侮辱主辦單位、意圖癱瘓及妨礙比賽之進行）本會得以搜集相關事證作出適當處分，並保留法律追訴權。</p>
            </div>
            <footer>
                <a href="{{  route('storage') }}" class="button alt">前往報名</a>
            </footer>
        </article>
    </div>
        ...
        <article class="box col-md-4">
            ...
            <div class="content">
                <ul>
                    ...
                    <li>競賽影片認證方式：請hashtag以下全部贊助廠商名稱，#快拍股份有限公司、#晨悅預防醫學、#寶齡富錦生技、#台灣大車隊、#H2O HOTEL、#桃園機場捷運、#創克股份有公司、#Juksy、#Qlive、#富士康廣告、#菲力斯國際。</li>
                </ul>
            </div>
            <header class="review-wrapper">
                <h3>複  賽  評  審  規  則</h3>
            ...
            <div class="content">
                <ul>
                    <li>參賽日期：2019/10/01 - 2019/10/31</li>
                    <li>參賽地點：網路競賽</li>
                    <li>競賽方式：請參賽者上傳15秒短影片至抖音</li>
...
<section id="four" class="wrapper post bg-img" data-bg="banner-5.jpg">
    <div class="inner">
        <article class="box">
            ...
            <div class="content">
                <ul>
                    <li>參賽日期：2019/11/01 - 2019/11/18</li>
                    <li>參賽地點：官方依評選結果另行通知參賽者</li>
                </ul>
            </div>
            <div class="content">
                <ul>
    ...
    <div class="inner">
        ...
        <article class="box-1">
            ...
            <ul class="finial-wrapper">
                ...
                <li>加總最高分者即為第一屆全球頂尖紅人對決世界冠軍</li>
                <li>冠軍可獨得獎金含獎品共50萬(新台幣)元整</li>
                <li>亞軍可獲得獎金含獎品共30萬(新台幣)元整</li>
