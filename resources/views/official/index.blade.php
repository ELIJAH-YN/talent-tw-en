    ...
    <div class="inner">
        <article class="box">
            ...
            <div class="content-wrapper">
                <p class="banner1-content">亞洲網路選秀最高賽事!! 全球頂尖紅人對決Global Top Talent Contest，由台灣最強網紅製作團隊快拍,重金打造網路才藝選秀舞台，在上海,北京,武漢,成都,杭州,台北,胡志明,曼谷,吉隆坡,大灣區十個城市分別舉辦，各區前三名,更將前進澳門金沙城劇院,與其他地區的才藝達人,共同爭取亞太區最強網紅的頭銜!!!</p>
            </div>
            <div class="content-wrapper">
...
<section id="three" class="wrapper post bg-img" data-bg="banner-4.jpg">
    <div class="inner">
        <article class="box col-md-4">
            ...
            <div class="content">
                <ul>
                    <li>參賽日期：2019/09/15 - 2019/09/30</li>
                    <li>參賽地點：網路競賽</li>
                    <li>競賽方式：請參賽者上傳15秒短影片至抖音</li>
                    <li>競賽內容：主題為任選各贊助廠商，推出產品宣傳創意影片。</li>
                    <li>計分方式：初賽時間內參賽者不限影片數量，以影片愛心數總計及評審計分。</li>
                    <li>競賽影片認證方式：請hashtag以下全部贊助廠商名稱，#快拍股份有限公司、#晨悅預防醫學、#菲力斯國際、#H2OHOTEL、#桃園機場捷運、#台灣大車隊、#寶齡富錦生技、#富士康廣告、#創克整合行銷、#Juksy、#Qlive、#好事聯播網、＃宅宅新聞、＃卡卡洛普、＃國王汽車、＃易珈生技、#原綺醫美集團。</li>
                </ul>
            </div>
            <header class="review-wrapper">
                <h3>複  賽  評  審  規  則</h3>
    ...
    <div class="inner">
        <article class="box-1">
            ...
            <ul class="finial-wrapper">
                <li>參賽日期：2019/12/14</li>
                <li>各賽區各取前三名前進澳門金沙城劇院</li>
                <li>抽籤依序上台演出,並由現場評審依照評分項目給分</li>
                <li>加總最高分者即為第一屆全球頂尖紅人對決世界冠軍</li>
                <li>冠軍可獨得獎金含獎品共50萬(NTD)元整</li>
                <li>亞軍可獲得獎金含獎品共30萬(NTD)元整</li>
